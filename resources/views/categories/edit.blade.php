            ...
            <div class="panel panel-default">
                ...
                {!! Form::open(['action' => ['CategoryController@update',$category->id], 'method' => 'PUT']) !!}
                    <div class="form-group">
                        ...
                        {{Form::text('name',$category->name,['class' => 'form-control', 'placeholder' => Lang::get('category.name') ])}}
                    </div>
                    <div class="form-group">
                        {{ Form::label('description', Lang::get('category.description')) }}
                        {{Form::textarea('description',$category->description,['class' => 'form-control', 'placeholder' => Lang::get('category.description') ])}}
                    </div>
                    <hr>
